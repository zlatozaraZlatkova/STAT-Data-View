...
describe('MetricCardComponent - Branch Coverage', () => {
  ...
  it('should format with unit when unitCategory.index exists', () => {
    ...
    expect(component.getFormattedValue()).toBe('5.0M');
  });
  ...
  it('should handle CLV10_MEUR unit', () => {
    ...
    expect(component.getFormattedValue()).toBe('5.0B');
  });
  ...
  it('should format THS_PER unit correctly', () => {
    const mockData: IEstatDataset = {
      value: { 0: 5000 },
      dimension: {
